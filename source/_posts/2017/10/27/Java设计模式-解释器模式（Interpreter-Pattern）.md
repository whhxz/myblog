...
<!-- more -->
UML类图如下：
![](/images/old/20171027屏幕快照2017-10-27下午2.07.29.png)
![](/images/old/20171027屏幕快照2017-10-27下午2.07.45.png)
```java
/**
 * 抽象表达式
 */
...
```
使用抽象语法树表示为如下：
![](/images/old/20171027屏幕快照2017-10-27下午3.31.56.png)
...
UML类图如下：
![](/images/old/20171027屏幕快照2017-10-27下午6.09.30.png)
```java
/**
 * 表达式抽象类
 */
